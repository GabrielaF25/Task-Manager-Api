...
public class CreateUserCommandHandler : IRequestHandler<CreateUserCommand, Result>
{
    ...
    public CreateUserCommandHandler(IUserRepository userRepository, IPasswordHasherService passwordHasherService, IValidator<CreateUserRequest> validator)
    {
    ...
    public async Task<Result> Handle(CreateUserCommand userToCreate, CancellationToken cancellationToken)
    {
       ...
       var createUser = new CreateUserRequest() { UserName = userToCreate.UserToCreate.UserName, Email = normalizedEmail };
        ...
        if (!resultValidator.IsValid)
        {
            ...
            return Result.Failed(errors, StatusType.ValidationError);
        }
